...
class ActeurV2(Models):
    ...
    mandats: Mapped[list["MandatV2"]] = relationship(
...
class MandatV2(Models):
    __tablename__ = "mandatv2"
    ...
    collaborateurs: Mapped[list["CollaborateurV2"]] = relationship(
        back_populates="mandat", cascade="all, delete-orphan"
    )
    suppleants: Mapped[list["SuppleantV2"]] = relationship(
        back_populates="mandat", cascade="all, delete-orphan"
    )

    __table_args__ = (
        Index("ix_mandatv2_acteur_uid", "acteur_uid"),
        Index("ix_mandatv2_organe_uid", "organe_uid"),
        Index("ix_mandatv2_legislature", "legislature"),
    )


class CollaborateurV2(Models):
    __tablename__ = "collaborateurv2"

    id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
    mandat_id: Mapped[int] = mapped_column(
        ForeignKey("mandatv2.id", ondelete="CASCADE"), nullable=False
    )
    ...
    mandat: Mapped[MandatV2] = relationship(back_populates="collaborateurs")


class SuppleantV2(Models):
    __tablename__ = "suppleantv2"
    ...
    mandat: Mapped[MandatV2] = relationship(back_populates="suppleants")
